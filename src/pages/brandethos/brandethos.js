...
const sections = [
  {
    ...
    img: "./images/brand-ethos-1.jpg", // replace with real image
    bg: "#fef9e7",
    reverse: false,
  },
  {
...
const AnimatedSection = ({ title, text, img, bg, reverse }) => (
  <div className="container-fluid no-padding">
    <div
      className={`row g-0 d-flex align-items-center my-3 ${
        reverse ? "flex-row-reverse" : ""
      }`}
      style={{ background: bg }}
    >
      <div className="col-md-3 p-0 d-flex justify-content-center justify-content-md-end">
        <motion.img
          src={img}
          alt={title}
